...
# - Uses checkpoint from $GIT_REPO_ROOT/output/MSVLPatchTST/checkpoints/weather_336_96
# - Runs test/inference only (no training)
# - Outputs to $GIT_REPO_ROOT/output/MSVLPatchTST/test_results/weather_336_96/
...
CKPT_DIR="$GIT_REPO_ROOT/output/MSVLPatchTST/checkpoints/weather_${seq_len}_${pred_len}"
OUTPUT_DIR="$GIT_REPO_ROOT/output/MSVLPatchTST/test_results/weather_${seq_len}_${pred_len}"
